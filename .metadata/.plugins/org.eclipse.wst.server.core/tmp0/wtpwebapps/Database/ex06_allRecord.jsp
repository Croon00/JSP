...
<body>
   ...
   <table>
      ...
      try {
         ...
         sql = "SELECT * FROM EMP02 ORDER BY empno"; 
         ...
         while (rs.next()) {
            ...
            out.println("<td><a class='btn' href='ex06_delete.jsp?empno=" 
                        + rs.getInt("empno") + "'>Delete</a></td>");
            // 수정 버튼 
            out.println("<td><a class='btn2' href='ex06_update.jsp?empno=" 
                        + rs.getInt("empno") + "'>Update</a></td>");
            out.println("</tr>");
         } //while의 끝
